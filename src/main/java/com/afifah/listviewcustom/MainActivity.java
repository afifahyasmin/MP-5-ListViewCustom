package com.afifah.listviewcustom;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fruitArrayAdapter = new FruitArrayAdapter(getApplicationContext(), R.layout.activity_main);
        ...
        for(String[] fruitData:fruitList ) {
            ...
            int fruitImgResId = getResources().getIdentifier(fruitImg, "drawable", "com.afifah.listviewcustom");
